	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				...
				<div class="tombol-opsi-container"><a href="proses/pengembalian-proses.php?&id=<?php echo $r_transaksi['idtransaksi'];?>" class="tombol" onclick="return confirm('Apakah yakin buku telah dikembalikan?');">Pengembalian</a></div>
			</td>
		</tr>
		<?php } ?>
	</table>
