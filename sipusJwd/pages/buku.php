	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				...
				<div class="tombol-opsi-container"><a href="proses/buku-hapus.php?id=<?php echo $r_tampil_buku['idbuku']; ?>" class="tombol" onclick="return confirm('Yakin ingin menghapus data?');" > Hapus </a></div>
			</td>
		</tr>
		<?php } ?>
	</table>
