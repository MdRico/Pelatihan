  ...
  <form action="proses/buku-input-proses.php" method="post" id="form">
    <table id="tabel-input">
      <tr>
        ...
        <td class="isian-formulir"><input type="text" name="id_buku" value="<?=$id?>"class="isian-formulir isian-formulir-border" readonly></td>
      </tr>
      <tr>
        <td class="label-formulir">Judul Buku</td>
        <td class="isian-formulir"><input type="text" name="judul_buku" id="judul" class="isian-formulir isian-formulir-border">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="isian-formulir"><input type="text" name="pengarang" id="pengarang" class="isian-formulir isian-formulir-border">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="isian-formulir"><input name="simpan" value="Simpan" class="tombol" onclick="validasi()" readonly style="cursor: pointer; width: 55px;"></td>
      </tr>
    </table>
  </form>
