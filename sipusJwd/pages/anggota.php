	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				...
				<div class="tombol-opsi-container"><a href="proses/anggota-hapus.php?id=<?php echo $r_tampil_anggota['idanggota']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="tombol">Hapus</a></div>
			</td>
		</tr>
		<?php } ?>
	</table>
