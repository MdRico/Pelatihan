  ...
  <form action="proses/anggota-edit-proses.php" method="POST" id="form">
    <table id="tabel-input">
      ...
      <tr>
        ...
        <td class="isian-formulir"><input type="text" name="name" value="<?php echo $r_tampil_anggota['nama']; ?>" class="isian-formulir isian-formulir-border" id="nama"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="isian-formulir"><textarea rows="2" cols="40" name="alamat" class="isian-formulir isian-formulir-border" id="alamat"><?php echo $r_tampil_anggota['alamat']; ?></textarea></td>
      </tr>
      <tr>
